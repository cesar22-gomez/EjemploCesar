...
public partial class Proyecto1BdContext : DbContext
{
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=GãMEZ\\SQLEXPRESS;Database=Proyecto1BD;TrustServerCertificate=True;Trusted_Connection=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.ClienteId).HasName("PK__Clientes__71ABD0A7C51FD67F");

            entity.HasIndex(e => e.Usuario, "UQ__Clientes__E3237CF7D02DA5C8").IsUnique();
        ...
        {
            entity.HasKey(e => e.DetalleId).HasName("PK__Detalles__6E19D6FA0DACA9AE");
            ...
            entity.HasOne(d => d.Orden).WithMany(p => p.DetallesOrden)
                ...
                .HasConstraintName("FK__DetallesO__Orden__5DCAEF64");

            entity.HasOne(d => d.Producto).WithMany(p => p.DetallesOrden)
                .HasForeignKey(d => d.ProductoId)
                .HasConstraintName("FK__DetallesO__Produ__5EBF139D");
        });
        ...
        {
            entity.HasKey(e => e.EntradaId).HasName("PK__Entradas__A08465947C1451FE");
            ...
            entity.HasOne(d => d.Producto).WithMany(p => p.EntradasProductos)
                .HasForeignKey(d => d.ProductoId)
                .HasConstraintName("FK__EntradasP__Produ__5812160E");
        });

        modelBuilder.Entity<Logueo>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Logueo__3214EC27AF961CC5");
        ...
        {
            entity.HasKey(e => e.MensajeId).HasName("PK__Mensajes__FEA0557F0FB1EFA4");
            ...
            entity.HasOne(d => d.Cliente).WithMany(p => p.Mensajes)
                ...
                .HasConstraintName("FK__Mensajes__Client__619B8048");
        });

        modelBuilder.Entity<OrdenesCompra>(entity =>
        {
            entity.HasKey(e => e.OrdenId).HasName("PK__OrdenesC__C088A4E4237F7D13");
            ...
            entity.HasOne(d => d.Usuario).WithMany(p => p.OrdenesCompra)
                ...
                .HasConstraintName("FK__OrdenesCo__Usuar__5AEE82B9");
        });

        modelBuilder.Entity<Productos>(entity =>
        {
            entity.HasKey(e => e.ProductoId).HasName("PK__Producto__A430AE83E32070BA");
